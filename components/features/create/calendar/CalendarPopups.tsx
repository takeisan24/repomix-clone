            ...
            >
                {!isEditingTime ? (
                    ...
                    <div className="flex items-center justify-center gap-3 px-3" style={{ minHeight: '55px' }}>
                        <button title="Xem/Soạn bài" onClick={() => onOpenInEditor(event, date)} className="w-10 h-10 p-2 rounded-full hover:bg-white/10 flex-shrink-0 flex items-center justify-center transition-colors">
                        ...
                        {isYellowNote && (
                            <>
                                ...
                                <button title="Sửa thời gian" onClick={handleEditTimeClick} className="w-10 h-10 p-2 rounded-full hover:bg-white/10 flex-shrink-0 flex items-center justify-center transition-colors">
                                    <img src="/Clock.svg" alt="edit time" className="opacity-80" style={{ width: 20, height: 20 }}/>
                                </button>
                                <div className="w-px h-6 bg-white/10" />
                                <button title="Xóa sự kiện" onClick={() => onConfirmDelete(event, date)} className="w-10 h-10 p-2 rounded-full hover:bg-white/10 flex-shrink-0 flex items-center justify-center transition-colors">
                    ...
                    <div className="p-4 flex flex-col gap-4 w-80">
                        <h3 className="text-lg font-semibold text-white">Sửa thời gian đăng</h3>
                        ...
                        <div className="flex justify-end gap-3">
                            <Button variant="ghost" onClick={() => setIsEditingTime(false)}>Hủy</Button>
                            <Button className="bg-primary hover:bg-primary/90" onClick={handleSaveTimeEdit}>Lưu</Button>
                        </div>
                    </div>
                )}
            </div>
