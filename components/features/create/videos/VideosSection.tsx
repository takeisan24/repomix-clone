          ...
          <Card 
                    ...
                    >
                        ...
                        <div className="transition-colors group-hover:text-white">
                            <div className="text-lg font-semibold text-white">{t('addSubtitles')}</div>
                            <div className="text-sm text-white/70 mt-1 group-hover:text-white/90">{t('addSubtitlesDesc')}</div>
                        </div>
                    </Card>
                    ...
                    >
                        ...
                        <div className="transition-colors group-hover:text-white">
                            <div className="text-lg font-semibold text-white">{t('mergeVideos')}</div>
                            <div className="text-sm text-white/70 mt-1 group-hover:text-white/90">{t('mergeVideosDesc')}</div>
                        </div>
                    </Card>
                    ...
                    >
                        ...
                        <div className="transition-colors group-hover:text-white">
                            <div className="text-lg font-semibold text-white">{t('extractClip')}</div>
                            <div className="text-sm text-white/70 mt-1 group-hover:text-white/90">{t('extractClipDesc')}</div>
                        </div>
                    </Card>
                </div>
                ...
                <div className="flex justify-center mb-8">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full max-w-2xl">
                        ...
                        >
                            ...
                            <div className="text-base font-medium text-white/90 group-hover:text-white">{t('generateBRolls')}</div>
                        </Card>
                        ...
                        >
                            ...
                            <div className="text-base font-medium text-white/90 group-hover:text-white">{t('translateSubtitles')}</div>
                        </Card>
                    </div>
                </div>
