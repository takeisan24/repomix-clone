        ...
        <div className="absolute -top-[31px] right-0 text-xs text-gray-400 pr-[10px]">
          {(postContents[selectedPostId] ?? "").length}/{getCharLimit()} {t('characterCount')}
                      ...
                      <div className="relative" ref={generateMenuRef}>
                        <Tooltip content={t('tooltips.generate')} position="top">
                          <Button
                            size="sm"
                            variant="outline"
                      ...
                      <div className="flex items-center gap-2 pr-[10px] pb-[15px]">
                        <Tooltip content={t('tooltips.clone')} position="top">
                          <Button 
                            size="sm" 
                            variant="outline" 
                        ...
                        <Tooltip content={t('tooltips.save')} position="top">
                          <Button 
                            size="sm" 
                            variant="outline" 
                          ...
                          >
                            {isSavingDraft ? t('saving') : t('save')}
                          </Button>
                        </Tooltip>
                        <Tooltip content={t('tooltips.publish')} position="top">
                          <Button
